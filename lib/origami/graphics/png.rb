  ...
  module Graphics
    class Png
      ...
      def build_pdf_object()
        ...
        case colors
        when 1
          puts "SETTING COLOR TO GRAY"
          color = :DeviceGray
        when 3
          puts "SETTING COLOR TO RGB"
          color = :DeviceRGB
        else
          raise Errors::UnsupportedImageType,
...
#          obj.data[:Mask] = rgb.collect { |x| [x, x] }.flatten
          ...
          puts "NO DETECTED TRANSPARENT STUFF"
        end
